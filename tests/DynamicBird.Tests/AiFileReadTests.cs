...
public class AiFileReadTests
{
    ...
    {
        string path = Path.Combine(Path.GetTempPath(), "dynbird-test-" + Guid.NewGuid().ToString("N") + ".docx");
    ...
    {
        string path = Path.Combine(Path.GetTempPath(), "dynbird-test-" + Guid.NewGuid().ToString("N") + ".txt");
    ...
    {
        string path = Path.Combine(Path.GetTempPath(), "dynbird-test-" + Guid.NewGuid().ToString("N") + ".bin");
