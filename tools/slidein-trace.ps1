# Trace panel Left during slide-IN (from offscreen to anchor)
Add-Type @"
using System;
using System.Text;
...
$HWND = [WN]::FindMain([uint32]$args[0], $TITLE)
# move to left edge (trigger slide-in)
[WN]::SetCursorPos(3, 300) | Out-Null
$sb = New-Object System.Text.StringBuilder
for ($i = 0; $i -lt 30; $i++) {
  $r = New-Object RECT
  [WN]::GetWindowRect($HWND, [ref]$r) | Out-Null
  $null = $sb.Append($r.Left).Append(" ")
  Start-Sleep -Milliseconds 40
}
"slideInLeftTrace: " + $sb.ToString()
