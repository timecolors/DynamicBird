...
- 提交本目录内容即代表你**保证拥有所上传代码的全部权利**，不侵犯任何第三方版权（含 MIT 等开源协议要求的保留版权声明）；
- 同意ShoreHue在其开源许可范围内**免费使用与分发**该内容；
- 若内容涉及侵权投诉，仓库按 GitHub 标准 DMCA 流程处理，责任由上传者承担。
